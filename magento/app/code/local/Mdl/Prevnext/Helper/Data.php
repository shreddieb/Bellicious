<?php
class Mdl_Prevnext_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
    ...
    public function getPreviousProduct()
    {
            ...
            $prodId = $currentProduct->getId(); //echo $prodId;
	...
	public function getHomeNextProduct()
    {
            $currentProduct = Mage::registry('current_product');
     ...
     * @return Mage_Catalog_Model_Product or FALSE
     */
    public function getHomePreviousProduct()
    {
            $currentProduct = Mage::registry('current_product');
