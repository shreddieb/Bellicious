<?php
class Mdl_Ajaxnav_Model_Layer_Filter_Attribute extends Mage_Catalog_Model_Layer_Filter_Attribute
{
    ...
    protected function _getItemsData()
    {
        ...
        $key .= Mage::helper('ajaxnav')->getCacheKey($this->_requestVar);
        ...
        if ($data === null) {
            ...
            $currentIds = Mage::helper('ajaxnav')->getParam($attribute->getAttributeCode());
            $tags = array(
