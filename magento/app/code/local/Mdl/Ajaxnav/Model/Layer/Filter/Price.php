<?php
	class Mdl_Ajaxnav_Model_Layer_Filter_Price extends Mage_Catalog_Model_Layer_Filter_Price
    {
        ...
        {
            $data = array();   
            $style = Mage::getStoreConfig('ajaxnav/ajaxnav/price_style'); 
            if ('default' == $style)
            {
        ...
        protected function _getCacheKey()
        {
            ...
            $key .= Mage::getStoreConfig('ajaxnav/ajaxnav/price_style');
            $key .= Mage::helper('ajaxnav')->getCacheKey('price');
            return $key;
        }   
        
        private function getFilterValueFromRequest()
        {
            $filter = Mage::helper('ajaxnav')->getParam($this->_requestVar);
        ...
        public function apply(Zend_Controller_Request_Abstract $request, $filterBlock)
        {
            ...
            if ('default' == Mage::getStoreConfig('ajaxnav/ajaxnav/price_style'))
            {
