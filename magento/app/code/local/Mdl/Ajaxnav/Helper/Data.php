<?php
class Mdl_Ajaxnav_Helper_Data extends Mage_Core_Helper_Abstract {

    protected $_params = null;
    protected $_continueShoppingUrl = null;

    const XML_PATH_CAT_STYLE = 'ajaxnav/ajaxnav/cat_style';
    const XML_PATH_REMOVE_LINKS = 'ajaxnav/ajaxnav/remove_links';
    const XML_PATH_RESET_FILTERS = 'ajaxnav/ajaxnav/reset_filters';
    ...
    public function isSearch() {
        ...
        if ('ajaxnav' === $mod && 'search' == Mage::app()->getRequest()->getActionName()) {
            return true;
        }
    ...
    public function wrapProducts($html) {
		...
		//$loaderHtml = '<div class="mdl_loading_filters" style="display:none"></div>';
        //$html .= $loaderHtml;
        ...
        if (Mage::app()->getRequest()->isXmlHttpRequest()) {
            ...
            $html = '<div id="mdl_layered_container">'
                    . $html
                    . '</div>'
                    . '';
        }
    ...
    public function getParams($asString = false, $without = null) {
        if (is_null($this->_params)) {
            ...
            $nCurrentPriceStyle = Mage::getStoreConfig('ajaxnav/ajaxnav/price_style');
