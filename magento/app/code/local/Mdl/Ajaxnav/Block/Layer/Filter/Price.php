<?php
class Mdl_Ajaxnav_Block_Layer_Filter_Price extends Mage_Catalog_Block_Layer_Filter_Price
{
    private $_filterType;  
    ...
    {
        parent::__construct(); 
		$this->_filterType = Mage::getStoreConfig('ajaxnav/ajaxnav/price_style');
		//Load Custom PHTML of price
		//echo 'mdl/ajaxnav/filter_price_' . $this->_filterType . '.phtml'; die;
        $this->setTemplate('mdl/ajaxnav/filter_price_' . $this->_filterType . '.phtml');
		//Set Filter Model Name
        $this->_filterModelName = 'ajaxnav/layer_filter_price';
    }
