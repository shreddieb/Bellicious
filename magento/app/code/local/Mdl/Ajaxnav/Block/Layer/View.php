<?php
class Mdl_Ajaxnav_Block_Layer_View extends Mage_Catalog_Block_Layer_View {
    ...
    public function __construct() {
        parent::__construct();
        $this->_helper = Mage::helper('ajaxnav');
    }
    ...
    public function getStateInfo() { 
        ...
        $ajaxUrl = '';
        if ($_hlp->isSearch()) {
            $ajaxUrl = Mage::getUrl('ajaxnav/front/search');
    ...
    protected function _prepareLayout() {
        ...
        foreach ($filterableAttributes as $attribute) {
            $blockType = 'ajaxnav/layer_filter_attribute';

            if ($attribute->getFrontendInput() == 'price') {
                $blockType = 'ajaxnav/layer_filter_price';
            }
    ...
    protected function createCategoriesBlock() {
        ...
        if ('none' != $_hlp->catStyle()) {
            $categoryBlock = $this->getLayout()->createBlock('ajaxnav/layer_filter_category')
                    ->setLayer($this->getLayer())
                    ->init();
