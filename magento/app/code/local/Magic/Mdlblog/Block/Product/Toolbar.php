...
class Magic_Mdlblog_Block_Product_Toolbar extends Magic_Mdlblog_Block_Product_ToolbarCommon
{
    ...
    public function getCurrentDirection()
    {
        ...
        return Mage::helper('mdlblog')->defaultPostSort(Mage::app()->getStore()->getId());
    }
