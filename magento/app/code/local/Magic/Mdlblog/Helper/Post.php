...
class Magic_Mdlblog_Helper_Post extends Mage_Core_Helper_Abstract
{
    /**
     * Renders CMS page
    ...
    {
        $page = Mage::getModel('mdlblog/post');
        ...
        $pageTitle = Mage::getSingleton('mdlblog/post')->load($identifier)->getTitle();
