...
class Magic_Mdlblog_Helper_Data extends Mage_Core_Helper_Abstract
{
    const XML_PATH_ENABLED = 'mdlblog/mdlblog/enabled';
    const XML_PATH_FOOTER_ENABLED = 'mdlblog/mdlblog/footerEnabled';
    const XML_CRUMBS_ENABLED = 'mdlblog/mdlblog/blogcrumbs';
    const XML_COMMENTS_PER_PAGE = 'mdlblog/comments/page_count';
    const XML_COMMENTS_ENABLED = 'mdlblog/comments/enabled';
    const XML_POSTS_PER_PAGE = 'mdlblog/mdlblog/perpage';
    const XML_BOOKMARKS = 'mdlblog/mdlblog/bookmarkslist';
    const XML_PATH_BOOKMARKS_POST = 'mdlblog/mdlblog/bookmarkspost';
    const XML_ROOT = 'mdlblog/mdlblog/route';
    const XML_CATEGORIES_URL = 'mdlblog/mdlblog/categories_urls';
    const XML_TAGCLOUD_SIZE = 'mdlblog/menu/tagcloud_size';
    const XML_BLOG_READMORE = 'mdlblog/mdlblog/readmore';
    const XML_BLOG_PARSE_CMS = 'mdlblog/mdlblog/parse_cms';
    const XML_BLOG_USESHORTCONTENT = 'mdlblog/mdlblog/useshortcontent';
    const XML_PATH_DATE_FORMAT = 'mdlblog/mdlblog/dateformat';
    const XML_DEFAULT_POST_SORT = "mdlblog/mdlblog/sorter"; 
	const STORE_CONFIG_JCAROUSEL = "mdlblog/mdlblog/carousel";

    /* menus and links */
    const XML_PATH_LAYOUT = 'mdlblog/mdlblog/layout';
    const XML_RECENT_SIZE = 'mdlblog/menu/recent';
    /* metadata */
    const XML_PATH_TITLE = 'mdlblog/mdlblog/title';
    const XML_PATH_KEYWORDS = 'mdlblog/mdlblog/keywords';
    const XML_PATH_DESCRIPTION = 'mdlblog/mdlblog/description';
    const DEFAULT_PAGE_COUNT = 10;
    const DEFAULT_ROOT = 'mdlblog';
    ...
    {
        return Mage::getStoreConfig('mdlblog/mdlblog/enabled') && $this->extensionEnabled('Magic_Mdlblog');
    }
	...
	public function getJcarousel()
    {
        $num = (int)Mage::getStoreConfig(self::STORE_CONFIG_JCAROUSEL);
        return $num;
    }
    ...
    {
        return (Mage::getStoreConfigFlag('mdlblog/rss/enable') && Mage::getStoreConfigFlag('rss/config/active'));
    }
    ...
    /**
     * Check is Magic_Mobile installed
     *
     * @return bool
     */
    public function isMobileInstalled()
    {
        return $this->isModuleOutputEnabled('Magic_Mobile')
            && @class_exists('Magic_Mobile_Block_Catalog_Product_List_Toolbar')
        ;
    }
}