...
class Magic_Mdlblog_Helper_Comment extends Mage_Core_Helper_Abstract
{
    public function renderPage(Mage_Core_Controller_Front_Action $action, $identifier = null, $data = array())
    {
        $page = Mage::getSingleton('mdlblog/mdlblog');
        ...
        $pageTitle = Mage::getSingleton('mdlblog/mdlblog')->load($identifier)->getTitle();
        $blogTitle = Mage::getStoreConfig('mdlblog/mdlblog/title') . " - ";
